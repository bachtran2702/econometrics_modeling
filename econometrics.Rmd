...
fit_sp = auto.arima(analysis_rdy_tsibble[,"SPY.Adjusted"], xreg = xreg, stepwise = F)
summary(fit_sp)
...
fc = forecast.StructTS(fit_sp, xreg = new_data)
checkresiduals(fc)
...
x <- seq(as.Date("2018-09-01"), as.Date("2024-10-1"), by = "1 month")
yearmonth(x)

fc %>%
gg_tsdisplay(fc) + aes(color = "#ED3833") +
  ylim(200,800) +
  ...
  theme(panel.background = element_blank(),
   ...
   #legend
        ...
        legend.box.background = element_rect(color="black", size = 0.65)) +
    #scales
        scale_y_continuous(n.breaks = 5)

scale_y_yearmonth()
continuous(n.breaks = 20)
```
