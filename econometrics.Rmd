...
vis_model + aes(color = "#ED3833", labels = "Historical Data") +
  ylim(200,800) +
  #scales
  scale_y_continuous(n.breaks = 10) +
  labs(x= "Monthly Data", y = "Dollars", caption = "Time Index: 1 = September 2018. Usage of SPDR's S&P 500 Trust ETF because scale and better fit") +
    #positions of title
