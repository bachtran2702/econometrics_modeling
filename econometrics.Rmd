...
#fix date index
month_index = as.ts(seq(as.Date("2018-09-01"), as.Date("2024-10-1"), by = "1 month"))
month_index_list = as.list(month_index)

plot_model = fc

  
fc["plot_model"] = as.list(month_index)
...
autoplot(fc) + aes(color = "#ED3833", labels = "Historical Data") +
  ...
  labs(x= "", y = "Dollars", caption = "Time Index September 2018 = 1") +
    #positions of title
